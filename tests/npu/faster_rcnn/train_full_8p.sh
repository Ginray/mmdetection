...
path_head="/home/syl/code/mmdetection"
...
sed -i "s|data/coco/|$data_path/|g" $path_head/configs/_base_/datasets/coco_detection.py
...
do
    ...
    then
        ...
        taskset -c $PID_START-$PID_END python3.7 $path_head/tools/train.py $path_head/configs/faster_rcnn/faster_rcnn_r50_fpn_1x_coco.py \
            --local_rank 0 \
            > ${test_path_dir}/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log 2>&1 &
    else
        python3.7 -m  torch.distributed.launch  --nproc_per_node 8 $path_head/tools/train.py $path_head/configs/faster_rcnn/faster_rcnn_r50_fpn_1x_coco.py \
            > ${test_path_dir}/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log 2>&1 &
    fi
done
...
sed -i "s|$data_path/|data/coco/|g" $path_head/configs/_base_/datasets/coco_detection.py
